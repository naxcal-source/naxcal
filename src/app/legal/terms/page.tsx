export default function TermsPage() {
  return (
    <article className="prose prose-sm max-w-none" style={{ color: "#374151" }}>
      <h1 style={{ color: "#0f172a" }}>Terms of Service</h1>
      <p className="text-sm" style={{ color: "#9ca3af" }}>Last updated: June 2026</p>
      <h2>1. Introduction</h2>
      <p>These Terms of Service (&quot;Terms&quot;) govern your use of the Naxcal platform operated by Naxcal Capital Ltd (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;). By accessing or using our services, you agree to be bound by these Terms.</p>
      <h2>2. Eligibility</h2>
      <p>You must be at least 18 years of age and legally capable of entering into binding contracts. You must complete our Know Your Customer (KYC) verification process before making deposits or withdrawals.</p>
      ...
      <p>To the maximum extent permitted by law, Naxcal shall not be liable for any indirect, incidental, or consequential damages arising from your use of our services.</p>
