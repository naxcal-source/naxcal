            ...
            <>
              ...
              <div className="flex gap-3">
                <button onClick={async () => {
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-3 rounded-lg text-sm font-medium cursor-pointer transition-all hover:bg-[#f8fafc]" style={{ border: "1px solid #e2e8f0", color: "#374151" }}>
