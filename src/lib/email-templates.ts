...
<div style="display:none;max-height:0;overflow:hidden;font-size:1px;color:#0a0a0a">Daily returns of 1.5–2.1% on your capital. FCA regulated. Withdraw anytime. &#8203;&nbsp;</div>
...
<table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%">
  ...
  <tr><td style="background:linear-gradient(160deg,#0d1f1a 0%,#060d10 60%,#0a0a0a 100%);padding:52px 40px 44px;text-align:center">
    ...
    <p style="margin:0 auto;max-width:420px;font-size:16px;color:rgba(255,255,255,0.55);line-height:1.7">
      Naxcal is an FCA-regulated investment platform generating consistent daily returns for a select group of private investors. We'd like to invite you in.
    </p>
  </td></tr>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td width="33%" style="padding:28px 12px 28px 0;border-right:1px solid rgba(255,255,255,0.06);text-align:center">
          ...
          <div style="font-size:11px;color:rgba(255,255,255,0.35);text-transform:uppercase;letter-spacing:1px;margin-top:4px">Daily Return</div>
        </td>
        <td width="33%" style="padding:28px 12px;border-right:1px solid rgba(255,255,255,0.06);text-align:center">
          ...
          <div style="font-size:11px;color:rgba(255,255,255,0.35);text-transform:uppercase;letter-spacing:1px;margin-top:4px">Active Investors</div>
        </td>
        <td width="33%" style="padding:28px 0 28px 12px;text-align:center">
          ...
          <div style="font-size:11px;color:rgba(255,255,255,0.35);text-transform:uppercase;letter-spacing:1px;margin-top:4px">Regulated</div>
        </td>
      </tr>
    </table>
  </td></tr>
  ...
  <tr><td style="background:#0d1117;padding:40px 40px 32px">
    <p style="margin:0 0 20px;font-size:15px;color:rgba(255,255,255,0.75);line-height:1.8">Hi ${name},</p>
    <p style="margin:0 0 20px;font-size:15px;color:rgba(255,255,255,0.65);line-height:1.8">
      We don't advertise. Naxcal grows through introductions — and you came highly recommended. So I'm reaching out directly to offer you early access before we close our current onboarding window.
    </p>
    <p style="margin:0 0 20px;font-size:15px;color:rgba(255,255,255,0.65);line-height:1.8">
    ...
    <p style="margin:0;font-size:15px;color:rgba(255,255,255,0.65);line-height:1.8">
  ...
  <tr><td style="background:#0d1117;padding:0 40px 40px">
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid rgba(255,255,255,0.08);border-radius:12px;overflow:hidden">
      <tr style="background:rgba(255,255,255,0.04)">
        <td style="padding:12px 20px;font-size:11px;font-weight:700;color:rgba(255,255,255,0.3);text-transform:uppercase;letter-spacing:1px">Tier</td>
        <td style="padding:12px 20px;font-size:11px;font-weight:700;color:rgba(255,255,255,0.3);text-transform:uppercase;letter-spacing:1px">Min. Deposit</td>
        <td style="padding:12px 20px;font-size:11px;font-weight:700;color:rgba(255,255,255,0.3);text-transform:uppercase;letter-spacing:1px">Daily Return</td>
        <td style="padding:12px 20px;font-size:11px;font-weight:700;color:rgba(255,255,255,0.3);text-transform:uppercase;letter-spacing:1px">Monthly Est.</td>
      </tr>
      <tr style="border-top:1px solid rgba(255,255,255,0.06)">
        <td style="padding:16px 20px"><span style="color:#cd7f32;font-weight:700;font-size:14px">Bronze</span></td>
        <td style="padding:16px 20px;color:rgba(255,255,255,0.6);font-size:14px">$1,000</td>
        <td style="padding:16px 20px;color:#22a882;font-weight:700;font-size:14px">1.5%</td>
        <td style="padding:16px 20px;color:rgba(255,255,255,0.6);font-size:14px">~45%</td>
      </tr>
      <tr style="border-top:1px solid rgba(255,255,255,0.06)">
        <td style="padding:16px 20px"><span style="color:#c0c0c0;font-weight:700;font-size:14px">Silver</span></td>
        <td style="padding:16px 20px;color:rgba(255,255,255,0.6);font-size:14px">$10,000</td>
        <td style="padding:16px 20px;color:#22a882;font-weight:700;font-size:14px">1.8%</td>
        <td style="padding:16px 20px;color:rgba(255,255,255,0.6);font-size:14px">~54%</td>
      </tr>
      <tr style="border-top:1px solid rgba(255,255,255,0.06);background:rgba(26,138,110,0.06)">
        ...
        <td style="padding:16px 20px;color:rgba(255,255,255,0.6);font-size:14px">$50,000</td>
        <td style="padding:16px 20px;color:#22a882;font-weight:700;font-size:14px">2.1%</td>
        <td style="padding:16px 20px;color:rgba(255,255,255,0.6);font-size:14px">~63%</td>
      </tr>
    </table>
  </td></tr>
      ...
      <tr>
        <td width="33%" style="padding-right:8px">
          <div style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);border-radius:10px;padding:16px;text-align:center">
            ...
            <div style="font-size:12px;font-weight:600;color:rgba(255,255,255,0.7)">FCA Regulated</div>
            <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:3px">UK authorised</div>
          </div>
        </td>
        <td width="33%" style="padding:0 4px">
          <div style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);border-radius:10px;padding:16px;text-align:center">
            <div style="font-size:20px;margin-bottom:6px">📊</div>
            <div style="font-size:12px;font-weight:600;color:rgba(255,255,255,0.7)">Live Dashboard</div>
            <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:3px">Real-time balance</div>
          </div>
        </td>
        <td width="33%" style="padding-left:8px">
          <div style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);border-radius:10px;padding:16px;text-align:center">
            <div style="font-size:20px;margin-bottom:6px">⚡</div>
            <div style="font-size:12px;font-weight:600;color:rgba(255,255,255,0.7)">Withdraw Anytime</div>
            <div style="font-size:11px;color:rgba(255,255,255,0.3);margin-top:3px">No lock-in period</div>
          </div>
        </td>
      </tr>
    </table>
  ...
  <tr><td style="background:linear-gradient(135deg,#0d2420,#0a1a14);padding:44px 40px;text-align:center;border-top:1px solid rgba(26,138,110,0.2)">
    <p style="margin:0 0 8px;font-size:13px;color:rgba(255,255,255,0.4);text-transform:uppercase;letter-spacing:2px;font-weight:600">Your Invitation</p>
    <h2 style="margin:0 0 12px;font-size:26px;font-weight:800;color:#ffffff">Ready to see it for yourself?</h2>
    <p style="margin:0 0 28px;font-size:14px;color:rgba(255,255,255,0.5);line-height:1.7">Create your account in under 2 minutes. No commitment required.</p>
    <a href="https://naxcal.com/register" style="display:inline-block;background:linear-gradient(135deg,#1a8a6e,#22a882);color:#ffffff;text-decoration:none;font-size:16px;font-weight:700;padding:16px 44px;border-radius:12px;letter-spacing:0.3px;box-shadow:0 4px 24px rgba(26,138,110,0.4)">Create My Account →</a>
    <p style="margin:20px 0 0;font-size:12px;color:rgba(255,255,255,0.2)">Or reply to this email — we're happy to answer any questions first.</p>
  </td></tr>
  ...
  <tr><td style="background:#060809;border-radius:0 0 16px 16px;padding:28px 40px;text-align:center;border-top:1px solid rgba(255,255,255,0.05)">
    ...
    <p style="margin:0 0 8px;font-size:11px;color:rgba(255,255,255,0.2);line-height:1.7">Naxcal Capital Ltd is authorised and regulated by the Financial Conduct Authority.<br>Your capital is at risk. Past performance is not indicative of future results.</p>
    <p style="margin:0;font-size:11px;color:rgba(255,255,255,0.15)">
      <a href="https://naxcal.com/legal/privacy" style="color:rgba(255,255,255,0.25);text-decoration:none">Privacy Policy</a> &nbsp;·&nbsp;
      <a href="https://naxcal.com/unsubscribe" style="color:rgba(255,255,255,0.25);text-decoration:none">Unsubscribe</a>
    </p>
  </td></tr>
