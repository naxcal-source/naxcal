      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10" style={{ backgroundColor: "#ffffff" }}>
        <div className="w-full max-w-md">
          ...
          <button onClick={async () => {
            ...
            className="w-full flex items-center justify-center gap-2 py-3 rounded-lg text-sm font-medium cursor-pointer transition-all hover:bg-[#f8fafc] disabled:opacity-50" style={{ border: "1px solid #e2e8f0", color: "#374151" }}>
